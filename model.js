...
export const rooms=[
 ...
 {id:2,floor:1,name:'Камінна кімната',area:'11,6',size:'Основна частина 3,12 × 3,23 м',x:5.08,z:3.15,h:KITCHEN_HEIGHT},
 {id:3,floor:2,name:'Вітальня',area:'10,6',size:'Стіна з вікнами 4,98 м · вікна 140 × 210 см',x:5.445,z:2.725,h:2.4},
 {id:4,floor:2,name:'Спальня',area:'8,97',size:'3,80 × 2,36 м · стеля 2,35–3,10 м',x:2.15,z:1.415,h:2.4},
 {id:5,floor:2,name:'Гостьова спальня',area:'8,97',size:'3,80 × 2,36 м · стеля 2,35–3,10 м',x:2.15,z:4.035,h:2.4},
 ...
 {id:7,floor:1,name:'Душ і туалет · прибудова',area:null,extension:true,size:'Вікно 50 × 60 см · чорна рама',x:1.8,z:6.42,h:2.62}
